...
import com.nexfit.exception.NoHandlerFoundException;
...
public class DispatcherServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		HandlerMapping handlerMapping = new AnnotationHandlerMapping("com.nexfit.controller");
