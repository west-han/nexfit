	...
	<div class="container-fluid px-0">
		...
		<div class="row gx-2">
				<jsp:include page="/WEB-INF/views/challenge/ch_leftbar.jsp"></jsp:include> <%-- 왼쪽사이드바 --%>
						...
						<h2 style="font-family: 'nexon lv2 medium';" class="text-with-border"> 챌린지 인증 </h2>
						</div>  
		...
		<div class="body-main">
				...
				<table class="table table-borderless">
					<tr>
						<td width="50%">
							<c:choose>
								<c:when test="${sessionScope.member.userId==dto.userId}">
									<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/certiboard/update?num=${dto.num}&page=${page}';">수정</button>
								</c:when>
								<c:otherwise>
						...
						<td class="text-end">
							<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/certiboard/list?page=${page}';">리스트</button>
						</td>
					</tr>
				</table>
