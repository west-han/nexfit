					...
					<div class="body-main">
						<form name="newChallengeForm" method="post"
							...
							<table class="table write-form mt-5">
								...
								<tr>
									<td class="bg-light col-sm-2" scope="row">챌린지 소개 및 <br>규
										&nbsp;&nbsp;칙
									</td>
									<td><textarea name="content" id="content"
											class="form-control" style="height: 200px">${dto.ch_content}</textarea>
									</td>
								</tr>
								...
								<tr>
									...
									<td><input type="text" name="fee" class="form-control"
										value="${dto.fee}" style="width: 200px;"></td>
								</tr>
								...
								<tr>
									<td class="text-center">
										...
										<button type="button" class="btn btn-light"
											onclick="location.href='${pageContext.request.contextPath}/challenge/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i
												class="bi bi-x"></i>
										</button> <c:if test="${mode == 'update'}">
											<input type="hidden" name="challengeId"
												value="${dto.challengeId}">
