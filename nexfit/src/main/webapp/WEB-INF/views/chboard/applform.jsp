			...
			<div class="container py-5">
				<div class="body-container m-auto ">
					<div class="body-title py-5">
						<h3>
							<i class="bi bi-clipboard"></i> 챌린지 신청서
						</h3>
					</div>
						...
						<form name="photoForm" method="post" enctype="multipart/form-data">
							<table class="table write-form mt-5">
								...
								<tr>
									...
									<td><input type="text" name="coment" class="form-control">
									</td>
								</tr>
								<tr>
							...
							<table class="table table-borderless">
								<tr>
									<td class="text-center">
										<button type="button" class="button button--nuka"
											onclick="sendOk();">${mode=='update'?'수정완료':'등록하기'}&nbsp;<i
												class="bi bi-check2"></i>
										</button>
										<button type="reset" class="button button--nuka">다시입력</button>
										<button type="button" class="button button--nuka"
											onclick="location.href='${pageContext.request.contextPath}/chboard/article?page=${page}&num=${num}';">
											신청취소&nbsp;<i class="bi bi-x"></i>
										</button> <input type="hidden" name="num" value="${dto.boardNumber}">
