	...
	<script type="text/javascript">
		function deleteBoard() {
		    if(confirm("게시글을 삭제 하시 겠습니까 ? ")) {
			    ...
			    let url = "${pageContext.request.contextPath}/chboard/delete?" + query;
		    	location.href = url;
		    }
		}
	</script>
	...
	<div class="container-fluid px-0">
		...
		<div class="row gx-2">
				<jsp:include page="/WEB-INF/views/challenge/ch_leftbar.jsp"></jsp:include> <%-- 왼쪽사이드바 --%>
						...
						<h2 style="font-family: 'nexon lv2 medium';" class="text-with-border"> Challenge View Details </h2>
						</div>  
		...
		<div class="body-main">
				...
				<div class="box">
						<div class="content font" >
							<header class="align-center"><p>Challenge : ${dto.ch_subject}</p>
								<hr>
						...
						<td width="50%" class="font">
							<c:choose>
								<c:when test="${sessionScope.member.userId=='admin'}">
									<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/chboard/update?num=${dto.boardNumber}&page=${page}';">수정</button>
								</c:when>
								<c:otherwise>
