						...
						<td width="50%">
							<c:choose>
								<c:when test="${sessionScope.member.userId=='admin'}">
									<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/chellenge/update?chellengeId=${dto.chellengeId}&page=${page}';">수정</button>
								</c:when>
								<c:otherwise>
